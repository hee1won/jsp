...
-- 페이징 (한 페이지에 15개)
SELECT * FROM Customers ORDER BY CustomerID LIMIT 0,15; -- 1페이지
SELECT * FROM Customers ORDER BY CustomerID LIMIT 15,15; -- 2페이지
SELECT * FROM Customers ORDER BY CustomerID LIMIT 30,15; -- 3페이지
SELECT * FROM Customers ORDER BY CustomerID LIMIT 45,15; -- 4페이지

-- 시작 위치 => (페이지번호 -1) * 페이지당 몇 개
