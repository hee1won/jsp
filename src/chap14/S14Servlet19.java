...
public class S14Servlet19 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int startPage = (pageNum -1) / 15 * 15 + 1;
		int endPage = startPage + 14;
		int lastPage = (total-1) / 10 + 1;
		
		int startRowNum = (pageNum - 1) * 15;
		...
		request.setAttribute("prevPage", startPage-15);
		request.setAttribute("nextPage", startPage+15);
